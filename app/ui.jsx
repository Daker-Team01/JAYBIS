...
function Icon({ name, size = 22, color = 'currentColor', stroke = 1.8, fill = 'none', style }) {
  ...
  const paths = {
    ...
    gear:   <><circle cx="12" cy="12" r="3" {...p}/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2 3.4-.2-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.5v.3h-4v-.3a1.7 1.7 0 0 0-1-1.5 1.7 1.7 0 0 0-1.9.3l-.2.1-2-3.4.1-.1A1.7 1.7 0 0 0 6 15a1.7 1.7 0 0 0-1.3-1.2h-.3v-4h.3A1.7 1.7 0 0 0 6 8.6a1.7 1.7 0 0 0-.3-1.9l-.1-.1 2-3.4.2.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.5v-.3h4v.3a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.2-.1 2 3.4-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.3 1.2h.3v4h-.3A1.7 1.7 0 0 0 19.4 15z" {...p}/></>,
